 ...
 * that slides beneath the labels and refracts them as it passes. The
 * thumb moves on transform alone; semantics are a radio group with
 * arrow-key roving.
 */
    ...
    >
      ...
      {options.map((option) => (
        <RadioGroupPrimitive.Item
          ...
          className={cn(
            "vt-ring-inset relative z-10 inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-pill px-4 text-muted-foreground transition-colors duration-200",
            size === "sm" ? "text-xs" : "text-sm",
            "hover:text-foreground data-[state=checked]:font-medium data-[state=checked]:text-foreground",
