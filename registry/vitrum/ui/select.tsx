  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        data-material="veil"
        className={cn(
          "vt-pop relative z-50 max-h-[min(24rem,var(--radix-select-content-available-height))] min-w-32 overflow-x-hidden overflow-y-auto rounded-pane p-1.5 text-foreground shadow-glass-lg",
          position === "popper" &&
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center gap-2 rounded-control py-1.5 pr-8 pl-2.5 text-sm outline-none",
